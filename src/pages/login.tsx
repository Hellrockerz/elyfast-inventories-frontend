            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full h-12 bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 focus:ring-2 focus:ring-blue-500 outline-none transition-all appearance-none text-white dark:text-gray-200"
                  required
                >
                  <option value="pharmacy" className="bg-slate-900 border-none outline-none">Pharmacy</option>
                  <option value="retail" className="bg-slate-900 border-none outline-none">Retail / General Store</option>
                  <option value="grocery" className="bg-slate-900 border-none outline-none">Grocery</option>
                </select>
              </div>
            </div>
